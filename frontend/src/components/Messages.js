  ...
  return (
    <div className="messages-workspace">
        ...
        <div className="active-user-contact">
          ...
          <div className="active-user-data">
            <div className="active-username">
              <label>
                <strong>Lumia Noella</strong>
              </label>
            </div>
            <div className="active-user-label">
              <label>@Lumia Noella</label>
            </div>
          </div>
        </div>
      </div>
      <div className="active-guest-messages">
        <div className="chat-datetime">
          ...
          <div className="chat-msg-user-contact">
            ...
            >
              <div className="user-profil" />
              <div className="chat-msg-data">
                <label id="chat-text">How are you ?</label>
              </div>
            </div>
            <div
              className="right-chat-msg"
              style={{ marginTop: 15, marginBottom: 5 }}
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">Good morning</label>
              </div>
              <div className="user-profil">
                <img
            ...
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">I'm fine, thanks !</label>
              </div>
              <div className="user-profil" />
            </div>
            <div
            ...
            >
              ...
              <div className="chat-msg-data">
                <label id="chat-text">Super</label>
              </div>
            </div>
            <div
              className="left-chat-msg"
            ...
            >
              ...
              <div className="chat-msg-data">
                <label id="chat-text">
                  Have you finish to do yours packs ?
                </label>
              </div>
            </div>
            <div
            ...
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">Not again</label>
              </div>
              <div className="user-profil">
                <img
                  src="data:image/jpeg;base64,"
            ...
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">I'm making that.</label>
              </div>
              <div className="user-profil" />
            </div>
            <div
            ...
            >
              ...
              <div className="chat-msg-data">
                <label id="chat-text">Alright</label>
              </div>
            </div>
          </div>
        </div>
        <div className="chat-datetime">
          <div className="msg-date" align="center">
            <label>August 22, 2022 06:11</label>
          </div>
          <div className="chat-msg-user-contact">
            <div
              className="left-chat-msg"
            ...
            >
              <div className="user-profil" />
              <div className="chat-msg-data">
                <label id="chat-text">I'm waiting for you.</label>
              </div>
            </div>
            <div
              className="left-chat-msg"
            ...
            >
              <div className="user-profil" />
              <div className="chat-msg-data">
                <label id="chat-text">Please, try to make that quickly.</label>
              </div>
            </div>
            <div
              className="right-chat-msg"
            ...
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">Received message 5/5</label>
              </div>
              <div className="user-profil" />
            </div>
            <div
            ...
            >
              <div className="crblank-space" />
              <div className="chat-msg-data">
                <label id="chat-text">See you later</label>
              </div>
              <div className="user-profil">
                <img
                  src="data:image/jpeg;base64,"
      ...
      <div className="message-editior">
        ...
        <div className="sender-icon" title="Send this message.">
